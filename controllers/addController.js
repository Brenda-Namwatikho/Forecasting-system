...
function uploaded(req, res) {
  ...
  fs.createReadStream(filePath)
    ...
    .on('data', (data) => {
      ...
      const sql = 'INSERT INTO salesorder (product_id, date, Quantity, CompetitorPrice, CompetitorCount, Promotion) VALUES (?, ?, ?, ?, ?, ?)';
      const values = [data.product_id, formattedDate, data.Quantity, data.CompetitorPrice, data.CompetitorCount, data.Promotion];
